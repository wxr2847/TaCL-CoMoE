...
def main(parser):
    ...
    if model_args.model_name_or_path.split("/")[-1] == "chatglm3-6b":
    ...
    if training_args.do_train:
        ...
        # my_tsne_dict = trainer.tsne_dict
        
        # # 保存字典
        # with open('/home/lizc/wxrproject/Chatglm3-MOELoRA-peft-master/results/tsne_dict.pkl', 'wb') as f:
        #     pickle.dump(my_tsne_dict, f)

        # # 加载字典
        # with open('tsne_dict.pkl', 'rb') as f:
    ...
    if training_args.do_eval:
        ...
        my_tsne_dict = trainer.tsne_dict
        # 保存字典
        with open('/home/lizc/wxrproject/Chatglm3-MOELoRA-peft-master/results/tsne_dict1.pkl', 'wb') as f:
            pickle.dump(my_tsne_dict, f)

    if training_args.do_predict:
        logger.info("*** Predict ***")

        # predict_data_collator = DataCollatorForSeq2Seq(
        #     tokenizer=tokenizer,
        #     model=model,  # 可选
        #     label_pad_token_id=-100,  # 避免 padding token 参与 loss
        #     padding=True
        # )
        ...
        predict_results = trainer.predict(
            ...
            # max_tokens=512,
            # data_collator=predict_data_collator,
