...
class Trainer:
    ...
    def compute_loss(self, model, inputs, return_outputs=False):
        ...
        outputs, hate_pred, pooled_encoder_layer = model(**inputs)
        ...
        for key, value in inputs.items():
            if key == "task_id":
                print(value)
                batch_task_id = set(value)
                print(batch_task_id)


        loss = loss + hate_contrastive_loss 
